...
Can this part also be added to the main?
I would like any loose elements to be in the main so I can see the flow of action on what is called and what is happening at each stage.
...
def setup_experiment(config_file='config_nsga2.yaml'):
    """Load the configuration from a YAML file and ensure the experiment directory exists."""
    ...
    # Create the experiment directory based on the name in the config
...
def main():
    # Setup experiment: load config and create the experiment directory
    config, experiment_directory = setup_experiment()
